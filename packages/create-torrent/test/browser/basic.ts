...
test('create single file torrent', (t) => {
  ...
  createTorrent(leaves, (err, torrent) => {
    ...
    ;(globalThis as typeof globalThis & { parsedTorrent?: unknown }).parsedTorrent = parsedTorrent
    hash(parsedTorrent.infoBuffer, 'hex').then((h) => {
      t.equals(h, 'd2474e86c95b19b8bcfdb92bc12c9d44667cfa36')
    })
  })
})
...
test('create multi file torrent', (t) => {
  ...
  createTorrent(
    ...
    (err, torrent) => {
      ...
      hash(parsedTorrent.infoBuffer, 'hex').then((h) => {
        t.equals(h, '80562f38656b385ea78959010e51a2cc9db41ea0')
      })
    }
  )
})
