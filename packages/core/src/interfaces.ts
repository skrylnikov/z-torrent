...
export interface PlatformAdapter {
  ...
  createDHT?(opts: Record<string, unknown>): Discovery | null
  ...
  createNatTraversal?(opts: Record<string, unknown>): { map: (opts: unknown) => Promise<void>; destroy: () => Promise<void> } | null
