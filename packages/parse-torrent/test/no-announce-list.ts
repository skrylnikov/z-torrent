...
const bitloveParsed = {
  ...
  infoHashBuffer: new Uint8Array(Buffer.from('4cb67059ed6bd08362da625b3ae77f6f4a075705', 'hex')),
...
test('parse torrent with no announce-list', async (t) => {
  t.deepEquals(await parseTorrent(bitloveIntro), bitloveParsed)
  t.end()
})
